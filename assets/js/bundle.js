...
var BBService = function () {
    _createClass(BBService, [{
        ...
        key: "processResults",
        value: function processResults(e) {
            console.log(e);
        ...
        key: "errorFn",
        value: function errorFn(e) {
            console.log("An error occurred. error is ");
            console.log("e.target.status" + "e.target.statusText");
        }
    }, {
        key: "buildProducts",
        value: function buildProducts(theJSON) {
            var productList = [];
            for (var index = 0; index < theJSON.products.length; index++) {
...
},{"../src/app":11,"./product":9}],2:[function(require,module,exports){
'use strict';
...
var _CarouselView = require('./CarouselView');
...
var Carousel = function () {
    function Carousel() {
        ...
        this.allProducts = [];
        this.carouselView = new _CarouselView2.default();
    }
...
},{"./CarouselView":3}],3:[function(require,module,exports){
'use strict';
...
var CarouselView = function () {
    ...
    _createClass(CarouselView, [{
        key: 'buildCarouselView',
        value: function buildCarouselView() {
            var _this = this;

            var flkty = new Flickity('.carousel', { initialIndex: 2 });

            var _loop = function _loop(i) {
                _this.cellElems = function () {
                    ...
                    var qvButton = document.createElement('button');
...
var Cart = function () {
    function Cart() {
        ...
        this.cartModal();
        this.allProducts = [];
        this.cartView = new _CartView2.default();
    }
    ...
    _createClass(Cart, [{
        ...
        value: function cartEventListener() {
        ...
        key: 'addSessionStorage',
        value: function addSessionStorage(e) {
...
var Main = function Main() {
  ...
  console.log("I'm importing from Main!");
};
...
var QuickView = function () {
  ...
  _createClass(QuickView, [{
    key: 'qvEventListener',
    value: function qvEventListener() {
    ...
    key: 'buildQuickView',
    value: function buildQuickView(e) {
      var dataSku = e.target.getAttribute('data-sku');
...
var SmoothScroll = function SmoothScroll() {
	...
	console.log("I'm importing from SmoothScroll!");
	if (!window['jQuery']) alert('The jQuery library must be included before the smoothscroll.js file.  The plugin will not work propery.');;(function ($) {
	...
	// Script for nav adjustments when scrolling past 100px from top of window
	(0, _jquery2.default)(function () {
		(0, _jquery2.default)(window).scroll(function () {
			if ((0, _jquery2.default)(window).scrollTop() >= 100) {
				(0, _jquery2.default)('nav').addClass('scrolled');
				(0, _jquery2.default)("#logo").attr("src", "assets/images/logo-white.png");
				(0, _jquery2.default)(".counter").addClass('counter-scroll');
				(0, _jquery2.default)("#cart-icon").attr("src", "assets/images/cart-white.png");
			} else {
				(0, _jquery2.default)('nav').removeClass('scrolled');
				(0, _jquery2.default)("#logo").attr("src", "assets/images/logo-black.png");
				(0, _jquery2.default)('.counter').removeClass('counter-scroll');
				(0, _jquery2.default)("#cart-icon").attr("src", "assets/images/cart-black.png");
			}
		});
	});
};
...
},{"../src/app":11}],11:[function(require,module,exports){
'use strict';
...
var _SmoothScroll = require('../lib/SmoothScroll');
...
var _CartView = require('../lib/CartView');

var _CartView2 = _interopRequireDefault(_CartView);

var _Carousel = require('../lib/Carousel');

var _Carousel2 = _interopRequireDefault(_Carousel);

var _QuickView = require('../lib/QuickView');

var _QuickView2 = _interopRequireDefault(_QuickView);

var _BBService = require('../lib/BBService');
...
var App = function () {
    function App() {
        ...
        this.allProducts = [];
        this.bbService = new _BBService2.default(this);
    }

    _createClass(App, [{
        key: 'init',
        value: function init(allProducts) {
...
},{"../lib/BBService":1,"../lib/Carousel":2,"../lib/Cart":4,"../lib/CartView":5,"../lib/Main":6,"../lib/QuickView":7,"../lib/SmoothScroll":8}],12:[function(require,module,exports){
/*!
